  ...
  <body <?php body_class(); ?>>
	...
	<?php include_once(TEMPLATEPATH. '/includes/nav.php'); ?>
		...
		<!--  <h1><a href="#">Wedding Planning Academy</a></h1> -->
			...
			<h2>CERTIFICATION FOR ASPIRING &amp; NOVICE WEDDING PLANNERS &amp; DESIGNERS.</h2>

			<h3>“Working with the team @ WEI has taken my experience and learning to the next level.
			I now have the confidence in my own abilities and the knowledge to make a difference.”</h3>
			<a class="large-button" href="<?php bloginfo('url'); ?>/certification/">GET CERTIFIED</a>
		</div><!--/span-->
