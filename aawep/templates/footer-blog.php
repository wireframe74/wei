<div class="footer-wrap">
 ...
 <link href="//cdn-images.mailchimp.com/embedcode/classic-081711.css" rel="stylesheet" type="text/css">
		...
		<form action="http://aawep.us5.list-manage2.com/subscribe/post?u=0406d9beb5d84b16eb3b6d454&id=d10021edfd" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
		  ...
		  <input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="form-control">
					...
					function mce_init_form(){
					    jQuery(document).ready( function($) {
					      ...
					      options = { url: 'http://aawep.us5.list-manage2.com/subscribe/post?u=0406d9beb5d84b16eb3b6d454&id=d10021edfd', type: 'GET', dataType: 'json', contentType: "application/json; charset=utf-8",
		...
		<!-- 		<div id="mc_embed_signup">
				...
				<a href="<?php bloginfo('url'); ?>/course-payment-types/" target="_blank">
					<img  
	 ...
	 <div class="quick-links no-padding">
						 ...
						 <section class="container site-links">
								...
								<aside class="group col-sm-4 col-md-4 col-lg-4 subscribe"> 
									<h2>NEWSLETTER SUBSCRIBE</h2> 
															<div id="mc_embed_signup">
																<form action="http://aawep.us5.list-manage2.com/subscribe/post?u=0406d9beb5d84b16eb3b6d454&id=d10021edfd" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate form-inline" target="_blank" novalidate="novalidate">
