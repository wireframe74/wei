<?php 
/* Template Name: ASK ALISON - ASK ALISON */
 get_header();
 ?>
	...
	<main role="main">
        ...
        <div class="container">
                   ...
                   <div class="col-md-12">
					<?php gravity_form(7, $display_title=false, $display_description=false, $display_inactive=false, $field_values=null, $ajax=true, $tabindex); ?>
					</div>
