...
// 	$p1['TAXAMT'] =  sprintf("%01.2f", ($p1['ITEMAMT'] + $p1['SHIPPINGAMT']) * .1);
	$p1['AMT'] =  sprintf("%01.2f",$p1['ITEMAMT']  + $p1['SHIPPINGAMT']);
...
<div id=\"logo\"><img src=\"http://www.aawep.com.au/assets/images/logo_uk.gif\" /></div>
...
echo "</p>";
?>
<a href="http://www.aawep.com.au"><img src="http://www.aawep.com.au/assets/images/return.gif" /></a>
</div>
</body>
</html>
